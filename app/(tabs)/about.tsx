      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            O Asteres é o seu guia de bolso para explorar o universo. Descubra planetas, luas e galáxias com imagens reais e dados astronômicos precisos.
          </Text>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoTextContainer}>
                ...
                <Text style={styles.infoDesc}>Tornar o espaço acessível a todos através da tecnologia.</Text>
              </View>
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoTextContainer}>
                ...
                <Text style={styles.infoDesc}>Aplicativo construído com React Native e Expo Router.</Text>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  description: { color: '#FFF', fontSize: 16, textAlign: 'center', lineHeight: 24, marginBottom: 30 },
  infoCard: { backgroundColor: '#1A1A2E', borderRadius: 15, padding: 20, width: '100%', marginBottom: 30 },
  infoRow: { flexDirection: 'row', alignItems: 'center' },
  infoTextContainer: { marginLeft: 15, flex: 1 },
  infoTitle: { color: '#FFF', fontSize: 16, fontWeight: 'bold', marginBottom: 2 },
  infoDesc: { color: '#888', fontSize: 14 },
  divider: { height: 1, backgroundColor: '#2A2A3E', marginVertical: 15 },
  button: { backgroundColor: '#4DB6AC', paddingVertical: 15, paddingHorizontal: 30, borderRadius: 25, width: '100%', alignItems: 'center' },
